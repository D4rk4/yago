...
1. Add explain output for admin users.
2. Add configurable ranking weights.
3. Validate ranking config before saving.
4. Store ranking config in persistent settings.
5. Provide default profile matching YaCy-ish behavior without overclaiming exact compatibility.
