...
the terminal transition under the lock so each run is counted exactly once; and
the Crawler section now renders a live running-crawls monitor (OBS-5) — an htmx
