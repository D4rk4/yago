...
* Per-process search admissions SHALL be treated as overload protection, not as
  ...
  validated bound. A replicated-read runtime or transport boundary SHALL require
  a separate accepted ADR and synchronized Docker, systemd, and package changes
