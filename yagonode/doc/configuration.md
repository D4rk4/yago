...
| `YAGO_SWARM_SEED_LIMIT_DOCS` | `15000` | Stop greedy-learning seeding once the local document store holds this many documents (YaCy `greedylearning.limit.doccount`); the bootstrap aid ends when the index is grown. |
