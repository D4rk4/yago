...
func TestParseRejectsDisallowedMethod(t *testing.T) {
	...
	_, _, _, ok := guard.Parse(rec, req, yagoproto.TransferURLEndpointMethods)
	if ok {
...
func TestParseAcceptsValidPost(t *testing.T) {
	...
	form, ctx, cancel, ok := guard.Parse(rec, req, yagoproto.TransferURLEndpointMethods)
	if !ok {
...
func TestParseAllowsUnsupportedContentEncoding(t *testing.T) {
	...
	form, _, cancel, ok := guard.Parse(rec, req, yagoproto.TransferURLEndpointMethods)
	if !ok {
