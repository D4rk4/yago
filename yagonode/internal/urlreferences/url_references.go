...
func (r *urlReferences) PostingStored(tx *vault.Txn, word, url yagomodel.Hash) error {
...
func (r *urlReferences) PostingPurged(tx *vault.Txn, word, url yagomodel.Hash) error {
