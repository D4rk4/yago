...
func TestLanguageToAnalyzer(t *testing.T) {
	cases := map[string]string{
		...
		"sr":      "hr",
		"bs":      "hr",
		"zh":      cjkChineseTextAnalyzer,
		"ja":      cjkJapaneseTextAnalyzer,
		"ko":      cjkKoreanTextAnalyzer,
...
func TestScriptAnalyzers(t *testing.T) {
	cases := map[*unicode.RangeTable][]string{
		...
		unicode.Han:        {cjkChineseTextAnalyzer, cjkJapaneseTextAnalyzer},
		unicode.Hiragana:   {cjkJapaneseTextAnalyzer},
		unicode.Hangul:     {cjkKoreanTextAnalyzer},
