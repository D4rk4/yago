...
func (fakeRoster) Discover(context.Context, ...yagomodel.Seed) {}

func (fakeRoster) ConfirmReachable(context.Context, yagomodel.Hash) {}

func (fakeRoster) ConfirmUnreachable(context.Context, yagomodel.Hash) {}

func (fakeRoster) RejectRemoteIndex(context.Context, yagomodel.Seed) {}

func (fakeRoster) FreshestPeers(context.Context, int) []yagomodel.Seed { return nil }
...
func (r reachableRoster) Discover(context.Context, ...yagomodel.Seed) {}

func (r reachableRoster) ConfirmReachable(context.Context, yagomodel.Hash) {}

func (r reachableRoster) ConfirmUnreachable(context.Context, yagomodel.Hash) {}

func (r reachableRoster) RejectRemoteIndex(context.Context, yagomodel.Seed) {}
...
func (c rwiCounter) RWIURLCount(context.Context, yagomodel.Hash) (int, error) {
	return 0, c.err
}
...
func (postingIndexOnly) RWIURLCount(context.Context, yagomodel.Hash) (int, error) {
	return 0, nil
}
