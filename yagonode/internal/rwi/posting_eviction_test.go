...
func (o *recordingObserver) PostingStored(_ *vault.Txn, _, _ yagomodel.Hash) error {
	return nil
}

func (o *recordingObserver) PostingPurged(_ *vault.Txn, word, _ yagomodel.Hash) error {
