...
func searchResponseCount(m yagomodel.Message) (int, error) {
...
func parseSearchIndexes(
	m yagomodel.Message,
) (map[yagomodel.Hash]int, map[yagomodel.Hash]string, error) {
	var (
		counts    map[yagomodel.Hash]int
		abstracts map[yagomodel.Hash]string
	)
