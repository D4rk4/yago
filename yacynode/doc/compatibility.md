...
| --- | --- | --- | --- | --- |
| Peer liveness handshake | `/yacy/hello.html` | GET, POST | implemented | Returns caller IP, caller peer type, own seed, and a bounded known seed list. |
| RWI and URL count query | `/yacy/query.html` | GET, POST | implemented | Answers YaCy-compatible count probes with target identity checks. |
...
| Surface | Path | Methods | Status | Behavior |
| --- | --- | --- | --- | --- |
| Tavily-compatible search | `/search` | POST | planned | Not mounted. Local/P2P Tavily-compatible search remains planned. |
...
parity, Solr/GSA compatibility, and Tavily-compatible local/P2P APIs remain
planned work.
