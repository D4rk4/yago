...
func TestHelloWireFixtures(t *testing.T) {
	...
	req, err := yacyproto.ParseHelloRequest(t.Context(), form)
	if err != nil {
		t.Fatalf("ParseHelloRequest: %v", err)
	}
	gotReq, err := yacyproto.ParseHelloRequest(t.Context(), req.Form())
	if err != nil {
	...
	resp, err := yacyproto.ParseHelloResponse(t.Context(), msg)
	if err != nil {
		t.Fatalf("ParseHelloResponse: %v", err)
	}
	encoded := resp.Encode()
	yacyproto.InjectResponseHeader(encoded, resp.Version, resp.Uptime)
	gotResp, err := yacyproto.ParseHelloResponse(t.Context(), encoded)
	if err != nil {
...
func TestQueryWireFixtures(t *testing.T) {
	...
	req, err := yacyproto.ParseQueryRequest(t.Context(), form)
	if err != nil {
		t.Fatalf("ParseQueryRequest: %v", err)
	}
	gotReq, err := yacyproto.ParseQueryRequest(t.Context(), req.Form())
	if err != nil {
	...
	encoded := resp.Encode()
	yacyproto.InjectResponseHeader(encoded, resp.Version, resp.Uptime)
	gotResp, err := yacyproto.ParseQueryResponse(encoded)
	if err != nil {
...
func TestTransferRWIWireFixtures(t *testing.T) {
	...
	gotReq, err := yacyproto.ParseTransferRWIRequest(t.Context(), req.Form())
	if err != nil {
	...
	encoded := resp.Encode()
	yacyproto.InjectResponseHeader(encoded, resp.Version, resp.Uptime)
	gotResp, err := yacyproto.ParseTransferRWIResponse(encoded)
	if err != nil {
...
func TestTransferURLWireFixtures(t *testing.T) {
	...
	gotReq, err := yacyproto.ParseTransferURLRequest(t.Context(), req.Form())
	if err != nil {
	...
	encoded := resp.Encode()
	yacyproto.InjectResponseHeader(encoded, resp.Version, resp.Uptime)
	gotResp, err := yacyproto.ParseTransferURLResponse(encoded)
	if err != nil {
...
func TestSearchWireFixtures(t *testing.T) {
	...
	gotReq, err := yacyproto.ParseSearchRequest(t.Context(), req.Form())
	if err != nil {
	...
	resp, err := yacyproto.ParseSearchResponse(msg)
	if err != nil {
		t.Fatalf("ParseSearchResponse: %v", err)
	}
	encoded := resp.Encode()
	yacyproto.InjectResponseHeader(encoded, resp.Version, resp.Uptime)
	gotResp, err := yacyproto.ParseSearchResponse(encoded)
	if err != nil {
...
func loadFixtureMessage(tb testing.TB, name string) yacymodel.Message {
	tb.Helper()
