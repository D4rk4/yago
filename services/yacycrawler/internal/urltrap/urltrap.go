...
// (canonicalurl.Canonicalize); these are the complementary *structural*
// heuristics (Olston & Najork, "Web Crawling", FnTIR 2010): a genuine page URL
// is short, shallow, and does not repeat a path segment or carry a wall of
// parameters. The thresholds are deliberately conservative so a real deep site
// is admitted and only runaway trap shapes are refused.
package urltrap
