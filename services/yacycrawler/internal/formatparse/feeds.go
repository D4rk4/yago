...
func parseXMLFeeds(rawURL, _ string, body []byte) (Document, bool) {
...
func parseRSS(rawURL string, body []byte) (Document, bool) {
	var feed rssFeed
...
func parseAtom(rawURL string, body []byte) (Document, bool) {
	var feed atomFeed
...
func parseGenericXML(rawURL string, body []byte) (Document, bool) {
...
func feedPage(rawURL, title, text string, links []string) Document {
