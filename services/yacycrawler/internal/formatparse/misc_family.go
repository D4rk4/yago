...
// Android packages.
func parseMisc(rawURL, _ string, body []byte) (Document, bool) {
...
// one file all index.
func parseVCard(rawURL string, body []byte) (Document, bool) {
...
func parseTorrent(rawURL string, body []byte) (Document, bool) {
...
func parseAPK(rawURL string, body []byte) (Document, bool) {
